...
namespace INMETRO.CIPP.SHARED.ModelShared
{
    public class SftpModel
    {
        ...
        public SftpModel(string localPath, string hostUri, string usuario, string privateKeyPath, string privateKeyPassword)
        {
            LocalPath = localPath;
        ...
        public SftpModel(string localPath, string hostUri, string usuario, string senha)
        {
            LocalPath = localPath;
            HostURI = hostUri;
            Usuario = usuario;
